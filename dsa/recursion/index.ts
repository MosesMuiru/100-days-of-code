 ...
 */
function towers(n:number,fromPeg:string,topeg:string,auxPeg:string):void{
if(n == 1){ console.log("moved disk 1 from  "+ fromPeg+" to " +topeg )
return
}
...
let myArra:number[] = [1,3,6,4];
function check(arr:number[],index:number):number{
